  ...
  color: #ffffff; 
    ...
    <body bgcolor="#000000">
        ...
        <div class="trains-image">
            <ul>
            <li><a class="active" href="index.php">Rute trenuri</a></li>
...
<div class="routes-panel">
    ...
    <form autocomplete="off" action="/Interface/index.php" method="get">
            <br><br><b><font size="+2">Numele stațiilor:</font></b><br><br><br>

            <div class="autocomplete" style="width:300px;">
                <input id="myInput" type="text" name="statiePlecare" placeholder="Stație de plecare.." required><br><br>
            </div>

            <div class="autocomplete2" style="width:300px;">
                <input id="myInput2" type="text" name="statieSosire" placeholder="Stație de sosire.." required><br><br>
            </div>
            ...
            -->
                ...
                <br><p><b class="date"><font size="+2">Data plecării:</font></b></p><br>
                <input type="date" name="data" value="2019-05-30" min="2019-05-30" max="2019-06-30"><br><br>
...
<?php
    ...
    $stid = oci_parse($conn, " SELECT st.nume_statie,ss.NUME_STATIE,tr.ORA_PLECARE,tr.ORA_SOSIRE,ID_TRASEU FROM statii st
    JOIN TRASEU tr ON st.ID_STATIE=tr.ID_STATIE_PLECARE
    JOIN statii ss ON tr.ID_STATIE_SOSIRE=ss.ID_STATIE
    WHERE st.NUME_STATIE='".$statie1."' AND ss.Nume_statie='".$statie2."'");
