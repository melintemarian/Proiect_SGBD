  ...
  color: #ffffff; 
    ...
    <body bgcolor="#000000">
        ...
        <div class="trains-image">
            ...
            <li><a class="active" href="mentenanta_tren.php">Caută mentenanță după tren</a></li>
            <li><a href="intarzieri.php">Întârzieri</a></li>
            <li><a href="rebalansare.php">Rebalansare</a></li>
        </ul>

            <div class="hero-text">
                <h1 style="font-size:50px">Caută mentenanță după tren</h1>
    ...
    <form autocomplete="off" action="/Interface/mentenanta_tren.php">
...
autocomplete(document.getElementById("myInput"), stations);
    ...
    $stid = oci_parse($conn, "  SELECT ID_REPARARE,M2.ID_LOCOMOTIVA,DATA_ADAUGARE,DATA_ELIBERARE,s2.NUME_STATIE from MENTENANTA M2
    join LOCOMOTIVA L2 on M2.ID_LOCOMOTIVA = L2.ID_LOCOMOTIVA
    join STATII S2 on L2.ID_STATIE_DOMICILIU = S2.ID_STATIE
    where M2.ID_LOCOMOTIVA='".$statie."'");
