...
<html>
    ...
    <body bgcolor="#000000">
        ...
        <div class="trains-image">
            ...
            <li><a class="active" href="rebalansare.php">Rebalansare</a></li>
        </ul>

            <div class="hero-text">
                <h1 style="font-size:50px">Rebalansare vagoane</h1>
    ...
    <form action="/Interface/rebalansare.php">

            <!--
            <br><br><b>Număr tren:</b><br><br><br>
            -->

                <input type="text" name="balans" placeholder="Număr de vagoane rebalansate" required><br><br>


                
                <input type="submit" value="Caută" name="ceva"><br><br>
