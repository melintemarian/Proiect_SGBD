  ...
  color: #ffffff; 
    ...
    <body bgcolor="#000000">
        ...
        <div class="trains-image">
            ...
            <li><a class="active" href="statie.php">Caută după stație</a></li>
            ...
            <div class="hero-text">
                <h1 style="font-size:50px">Caută după stație</h1>
    ...
    <form autocomplete="off" action="/Interface/statie.php">
...
autocomplete(document.getElementById("myInput"), stations);
    ...
    $stid = oci_parse($conn, " SELECT st.NUME_STATIE,ss.NUME_STATIE,ORA_PLECARE,ID_TRASEU from statii st
    ...
    echo "<table class ='white-table' border='1'>\n";
        ...
        $stid = oci_parse($conn, " SELECT ss.NUME_STATIE,st.NUME_STATIE,ORA_PLECARE,ID_TRASEU from statii st
