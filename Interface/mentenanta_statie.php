  ...
  color: #ffffff; 
    ...
    <body bgcolor="#000000">
        ...
        <div class="trains-image">
            ...
            <li><a class="active" href="mentenanta_statie.php">Caută mentenanță după stație</a></li>
            ...
            <div class="hero-text">
                <h1 style="font-size:50px">Caută mentenanță după stație</h1>
    ...
    <form autocomplete="off" action="/Interface/mentenanta_statie.php">
        ...
        <div class="autocomplete" style="width:300px;">
            <input id="myInput" type="text" name="station" placeholder="Numele stației.." required>
        </div>
...
autocomplete(document.getElementById("myInput"), stations);
    ...
    $stid = oci_parse($conn, "  SELECT NUME_STATIE,ID_REPARARE,mt.ID_LOCOMOTIVA,DATA_ADAUGARE,DATA_ELIBERARE from MENTENANTA mt
    join statii st on st.ID_STATIE=mt.ID_STATIE
    where st.NUME_STATIE='".$statie."'");
    //oci_bind_by_name($stid, ':var1', $statie1);
    //oci_bind_by_name($stid, ':var2', $statie2);
    oci_execute($stid);
    echo "<table border='1' class ='white-table'>\n";
